"""
Django settings for fashion_design_system project.
...
SECRET_KEY = 'django-insecure-pj(8#cgs+yx@m7q7-6y(+j*8!@imbzotnr-8$l2fza*c0qi-m('
...
ROOT_URLCONF = 'fashion_design_system.urls'
...
WSGI_APPLICATION = 'fashion_design_system.wsgi.application'
